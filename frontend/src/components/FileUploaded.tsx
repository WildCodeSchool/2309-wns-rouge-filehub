...
function FileUploaded({file, setFileUploaded}: fileUploadedProps): React.ReactNode {
            ...
            <FileInfo>
                ...
                <Container>
                    <Label>
                        ...
                        <Field onClick={()=>handleCopy(file.path)} style={{cursor: "pointer"}}>
                            {file.path}
                        </Field>
                    </Label>
                </Container>
                <Container>
                    <ButtonCopy variant="contained" onClick={()=>handleCopy(file.path)} 
