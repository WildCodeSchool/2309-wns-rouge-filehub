    ...
    return (
        <header style={headerStyle}>
            <div style={containerStyle}>
                <img src="../../public/Logo-fileHub-v1.png" alt="Logo" style={logoStyle} />
